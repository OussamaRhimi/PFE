...
const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'candidateDetail.experienceInputed':  { fr: 'Saisie par le candidat :', en: 'Entered by candidate:' },
  'candidateDetail.experienceRequired': { fr: 'Requise :', en: 'Required:' },
  'candidateDetail.notProvided':        { fr: 'Non renseignee', en: 'Not provided' },
  'candidateDetail.notSpecified':       { fr: 'Non specifiee', en: 'Not specified' },
  'candidateDetail.experienceNoRequirement': { fr: 'Aucune exigence specifiee', en: 'No requirement specified' },
  'candidateDetail.experienceMetBoth':  { fr: 'Respectee (IA + saisie)', en: 'Met (AI + entered)' },
  'candidateDetail.experienceMetAi':    { fr: 'Respectee (IA uniquement)', en: 'Met (AI only)' },
  'candidateDetail.experienceMetInput': { fr: 'Respectee (saisie uniquement)', en: 'Met (entered only)' },
