...
@Component({
    ...
    <div class="search-input-wrapper">
      ...
      <div class="autocomplete-dropdown" *ngIf="showDropdown && suggestions.length > 0">
        <div
          ...
          *ngFor="let s of suggestions; let i = index"
          ...
          [innerHTML]="highlight(s.name, query)"
        ></div>
      </div>
      ...
      <div class="autocomplete-dropdown no-results"
        ...
        <div class="autocomplete-item disabled">No skills found</div>
      </div>
...
export class SkillAutocompleteComponent implements OnInit, OnDestroy {
    ...
    @Output() searchResults = new EventEmitter<Skill[]>();
    ...
    constructor(private skillService: SkillService, private elRef: ElementRef) { }
    ...
    selectSuggestion(skill: Skill): void {
        ...
        this.suggestions = [skill];
        this.searchResults.emit([skill]);
