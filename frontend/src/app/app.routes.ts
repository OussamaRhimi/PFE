...
import { AiEvaluationComponent } from './pages/ai-evaluation/ai-evaluation.component';
...
import { RecommendationComponent } from './pages/public-jobs/recommendation.component';
...
export const routes: Routes = [
  ...
  {
    path: 'ai-evaluation',
    component: AiEvaluationComponent,
    canActivate: [authGuard],
  },
  {
